...
export default function Profile() {
  ...
  return (
    <span className='profile p-2'>
        {/* Below we call to the currentUser object to properly greet a logged in user. If displayName was null,
            we dispaly currentUser.email. If we have a displayName to ccall upon, we called it using .split:
